...
STRINGS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "sources.group.import": "📂 Импорт файлов / Вставка",
        "sources.btn.import_file": "📂 Из файла...",
        "sources.btn.import_paste": "📋 Вставить текст",
        "sources.input.import.placeholder": "Вставь URI-конфиги сюда (по одному на строку)...",
    ...
    "en": {
        ...
        "sources.chk.github_push": "📤 GitHub",
        "sources.group.import": "📂 Import Files / Paste",
        "sources.btn.import_file": "📂 From file...",
        "sources.btn.import_paste": "📋 Paste text",
        "sources.input.import.placeholder": "Paste URI configs here (one per line)...",
