...
STRINGS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "sources.btn.quick_search": "🔍 Быстрый",
        "sources.btn.deep_search": "🔎 Глубокий",
        ...
        "download.stats.sources_ok": "{ok}/{total} ок",
        ...
        "log.no_proxies_warning": "⚠ Нет скачанных прокси. Дождитесь загрузки или добавьте ещё источники.",
    ...
    "en": {
        ...
        "sources.btn.quick_search": "🔍 Quick",
        "sources.btn.deep_search": "🔎 Deep",
        ...
        "download.stats.protocol": "{proto}: {count}",
        "download.stats.sources_ok": "{ok}/{total} ok",
        ...
        "log.no_proxies_warning": "⚠ No proxies downloaded yet. Wait for fetch or add more sources.",
