...
STRINGS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "test.security.all": "Любой",
        "test.security.tls": "TLS",
        "test.security.reality": "Reality",
        "test.security.none": "None",
        ...
        "notify.test_done": "Тестирование завершено: {valid}/{total} валидных",
        ...
        "export.chk.dns_hook": "Заменять DNS на DoH (обход блокировок РФ)",
        ...
        "export.github.cdn_copied": "📋 CDN ссылка скопирована",
        "export.label.cdn_url": "🌐 CDN ссылка (jsDelivr):",
        "export.btn.cdn_copy": "📋 Копировать",
    ...
    "en": {
        ...
        "notify.test_done": "Testing complete: {valid}/{total} valid",
        ...
        "export.chk.dns_hook": "Replace DNS with DoH (bypass RF blocks)",
        ...
        "export.github.cdn_copied": "📋 CDN link copied",
        "export.label.cdn_url": "🌐 CDN link (jsDelivr):",
        "export.btn.cdn_copy": "📋 Copy",
